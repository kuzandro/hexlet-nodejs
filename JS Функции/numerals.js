...
Анализ и сравнение:
На вход succ подаедтся функция (количество применения увеличения)
Сама функция n от двух аргументов f - увеличение x - 0
в теле вызывается функция увеличения от функции количества раз с аргументами функции увеличения и нуля
ноль берет функцию увеличения и ноль и возвращает ноль